...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="wiener-schnitzler" select="document('https://raw.githubusercontent.com/wiener-moderne-verein/wienerschnitzler-data/refs/heads/data/data/editions/xml/wienerschnitzler_complete_nested.xml')"></xsl:param>
