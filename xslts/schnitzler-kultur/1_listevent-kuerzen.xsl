...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <!-- Dieses XSLT wird auf die bestehende Datei
        schnitzler-kultur_tage.xml angewandt und ersetzt sie durch
        die neuesten Daten aus der PMB: 
        https://pmb.acdh.oeaw.ac.at/media/listevent.xml
        (anpassung eventName -> head, alles in desc)
    -->
    
    <xsl:param name="listEvent" select="document('https://raw.githubusercontent.com/arthur-schnitzler/schnitzler-kultur/refs/heads/main/data/editions/listevent.xml')"/>
          ...
          <xsl:element name="fileDesc" namespace="http://www.tei-c.org/ns/1.0">
              <xsl:element name="titleStmt" namespace="http://www.tei-c.org/ns/1.0">
                  ...
                  <xsl:element name="respStmt" namespace="http://www.tei-c.org/ns/1.0">
                      ...
                      <xsl:element name="name" namespace="http://www.tei-c.org/ns/1.0">
                          <xsl:text>Selma Jahnke</xsl:text>
                      </xsl:element>
                      <xsl:element name="name" namespace="http://www.tei-c.org/ns/1.0">
              ...
              <xsl:element name="publicationStmt" namespace="http://www.tei-c.org/ns/1.0">
                  <xsl:element name="publisher" namespace="http://www.tei-c.org/ns/1.0">
                      <xsl:text>Austrian Centre for Digital Humanities</xsl:text>
                  </xsl:element>
                  ...
                  <xsl:element name="idno" namespace="http://www.tei-c.org/ns/1.0">
                      ...
                      <xsl:value-of
                          select="'https://github.com/arthur-schnitzler/schnitzler-kultur/blob/main/data/editions/listevent.xml'"
                      />
                  </xsl:element>
                  <xsl:element name="idno" namespace="http://www.tei-c.org/ns/1.0">
                      <xsl:attribute name="type">
              ...
              <xsl:element name="sourceDesc" namespace="http://www.tei-c.org/ns/1.0">
                  <xsl:element name="p" namespace="http://www.tei-c.org/ns/1.0">
                      <xsl:text>Ereignisse in Schnitzler-Kulturveranstaltungen, https://schnitzler-kultur.acdh.oeaw.ac.at/</xsl:text>
                  </xsl:element>
              </xsl:element>
          </xsl:element>
      </xsl:element>
