        ...
        <xsl:for-each-group select="tei:event[@when-iso &gt;= '1862-05-15' and @when-iso &lt;= '1931-10-21']" group-by="@when-iso">
            ...
            <xsl:element name="item" namespace="http://www.tei-c.org/ns/1.0">
                ...
                <xsl:element name="listEvent" namespace="http://www.tei-c.org/ns/1.0">
                    ...
                    <xsl:apply-templates
                        select="current-group()[tei:idno[1]/@type = 'schnitzler-kultur' or tei:idno[1]/@subtype = 'schnitzler-kultur']"/>
                    <xsl:apply-templates
                    ...
                    <xsl:apply-templates
                        select="current-group()[tei:idno[1]/@type = 'schnitzler-fischer' or tei:idno[1]/@subtype = 'schnitzler-fischer']"/>
                    <xsl:apply-templates
